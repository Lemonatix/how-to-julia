...
# ╔═╡ 5a1db0d5-a4af-4b81-a3d4-67410fcc3c9e
md"""
...
# ╔═╡ 2d3a87d9-c0cd-4331-a98e-429094b9d3dc
md"""
!!! correct "Hier nun die Aufgabe"
    Schreiben Sie die Funktion `black_jack_wertigkeiten`.
"""

# ╔═╡ c91ff1f3-271b-4ed0-b3fc-f7513d5171b9
"""
...
function black_jack_wertigkeiten(hand::Vector{Spielkarte}) :: Vector{Int}
	if length(hand) == 0  return [0,]  end   # leere Hand: Liste mit nur 0 drin
	error("Dieser Teil fehlt")
end
